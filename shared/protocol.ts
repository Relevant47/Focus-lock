...
export interface SessionState {
  ...
  signature: string; // HMAC-SHA256 of everything above (excluding motivationalMessage + intention + blockAttempts). pomodoroConfig contributes its 5 fields (strictMode, workMinutes, breakMinutes, longBreakMinutes, cyclesBeforeLongBreak); null serializes as empty strings.
}
