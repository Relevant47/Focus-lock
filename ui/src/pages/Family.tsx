      ...
      {expanded && (
        <div className="space-y-3 pt-2 border-t border-border/50">
          ...
          <div className="space-y-2">
            ...
            <div>
              <label className="text-[11px] text-muted block mb-1">{`Apps (comma-separated, e.g. ${device.os === 'windows' ? 'discord.exe, steam.exe' : 'Discord, Steam'})`}</label>
              <input value={apps} onChange={e => setApps(e.target.value)}
                className="input-base w-full px-3 py-2 text-sm font-mono" placeholder={device.os === 'windows' ? "discord.exe, steam.exe" : "Discord, Steam"} />
            </div>
            <div>
