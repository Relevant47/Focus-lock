...
// so callers can queue and retry. Base URL defaults to the apex domain
// (tryfocuslock.com); override with VITE_SURVEY_API_URL at build time for
// preview deployments or self-builds.
const ENV_URL: string | undefined = (import.meta as any).env?.VITE_SURVEY_API_URL;
export const surveyApiUrl: string = ENV_URL ?? 'https://tryfocuslock.com';
